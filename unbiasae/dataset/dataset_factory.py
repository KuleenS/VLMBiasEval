...
def dataset_eval_generator(dataset_name: str, input_folder: Path, mode: str, type_of_dataset: str) -> Tuple[Dict[str, Dict[str, str] | List], BaseEvaluateDataset]:
    ...
    dataset: BaseDataset = dataset_class(input_folder, mode)

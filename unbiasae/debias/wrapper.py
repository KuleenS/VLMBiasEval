...
class InterventionWrapper:
    ...
    def __init__(self, model, processor, model_name: str, include_image: bool, device: str = "cuda"):
    ...
    def get_hook(
        ...
        """
        module = self.layers[model_params["targ_layer"]]
        ...
        if intervention_type in [
            ...
            steering_vector_threshold = (
                ...
                + steering_vector_threshold_bias
            )
